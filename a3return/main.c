...

{
	...
	double R_rate;          // Reproductive rate of host
	double Avg_Eggs;        // Average number of viable eggs deposited by parasitoid on a single host
	double Search_Eff;      // Searching efficiency constant of parasitoid
